...
def load_data(datafile = "cifar100", target_size = (224,224,3), num_class = 100, test_percent=0.2):
    """"
    ...
    if num_class == 10 and datafile=="cifar10":
        (x_data, y_data), (x_test, y_test) = cifar10.load_data()
    elif num_class == 100 and datafile=="cifar100":
        (x_data, y_data), (x_test, y_test) = cifar100.load_data()
    else:
...
def get_parameter_numbers():
    """
    get # of parameters in that model
    """
    num_params = 0
