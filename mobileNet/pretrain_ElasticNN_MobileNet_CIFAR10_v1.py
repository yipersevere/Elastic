...
def pretrain():
    ...
    model_name = "Elastic-MobileNet_alpha_0.75_CIFAR10"
    folder_path = "./Train_MobileNet" + "/CIFAR10"
    num_classes = 10
    ...
    imageStr = {
        ...
        "ax0_title": "ElasticNN-MobileNet-alpha-0.75 test on CIFAR 10",
        "ax1_set_ylabel": "f1 score on CIFAR-10",
        "ax1_title": "f1 score ElasticNN-MobileNet-alpha-0.75 test on CIFAR 10",
        "save_fig" : "ElasticNN-MobileNet-alpha-0.75_CIFAR_10.pdf"
    }
   # ==============Done parameters============
    ...
    LOG("Pre-training CIFAR-10 on ElasticNN-MobileNet, alpha = 0.75...")
    ...
    model.fit_generator(train_generator,
                        ...
                        verbose=0,
                        validation_data=(X_val, [y_val]*num_outputs),
                        callbacks=[history_logger, checkpointer2,lr_reducer, early_stop])
