...
def pretrain():
    ...
    imageStr = {
        ...
        "ax0_title": "MobileNet-alpha-0.75 test on CIFAR 10",
        "ax1_set_ylabel": "f1 score on CIFAR-10",
        "ax1_title": "f1 score MobileNet-alpha-0.75 test on CIFAR 10",
        "save_fig" : "MobileNet-alpha-0.75_CIFAR_10.pdf"
    }
   # ==============Done parameters============
    ...
    LOG("Pre-training CIFAR-10 on MobileNet, alpha = 0.75...", logFile)
