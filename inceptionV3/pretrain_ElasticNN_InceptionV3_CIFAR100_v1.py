...
def pretrain():
    ...
    folder_path = "./Pretrained_ElasticNN" + "/CIFAR100"
    num_classes = 100
    ...
    imageStr = {
        ...
        "ax0_title": "ElasticNN-InceptionV3 test on CIFAR 100",
        "ax1_set_ylabel": "f1 score on CIFAR-100",
        "ax1_title": "f1 score ElasticNN-InceptionV3 test on CIFAR 100",
        "save_fig" : "ElasticNN-InceptionV3_CIFAR_100.pdf"
    }
   # ==============Done parameters============
    ...
    LOG("Pre-training CIFAR-100 on ElasticNN-InceptionV3...", logFile)
    ...
    for layer, no_layerin zip(add_layers, range(len(add_layers))):
        w = layer.output
        name = layer.name
    ...
    history_logger = HistoryLogger(model.optimizer, path, batch_size, epoch_size, x_test, y_test, num_outputs, multi_generator, logFile)
