...
def pretrain():
    ...
    folder_path = "./Train_InceptionV3" + "/CIFAR10"

    batch_size = 32
    epoch_size = 1000 #数据迭代的轮数
    num_outputs = 1
    num_classes = 10
    target_size = (224,224,3)
    imageStr = {
        "ax0_set_ylabel": "error rate on CIFAR-10",
        "ax0_title": "InceptionV3 test on CIFAR 10",
        "ax1_set_ylabel": "f1 score on CIFAR-10",
        "ax1_title": "f1 score InceptionV3 test on CIFAR 10",
        "save_fig" : "InceptionV3_CIFAR_10.pdf"
    }
    # ==============Done parameters============
    ...
    LOG("Pre-training CIFAR-10 on InceptionV3...", logFile)
    ...
    # define own neural network module -- ElasticNN-Inception V3
