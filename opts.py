...
parser.add_argument('--data', type=str, help="training and testing data, data=cifar10; data=cifar100, tiny_imagenet", default="cifar100")
...
parser.add_argument('--epochs', type=int, help="epoch number, default 1, set 100 or 1000", default=2)
parser.add_argument('--dropout_rate', type=float, help="dropout rate, (default: 0.2)", default=0.2)
parser.add_argument('--batch_size', type=int, help="batch size for training and testing, (default: 16)", default=32)
...
parser.add_argument('--model', type=str, help="model folder, like ElasticNN-ResNet50", default="Elastic_ResNet18")
parser.add_argument('--model_name', type=str, help="exact model name", default="pytorch_tiny_imagenet_4_intermediate_classifiers_Elastic_ResNet18")
