...
def pretrain():
    ...
    model_name = "Elastic-ResNet50_CIFAR100"
    folder_path = "./Train_ElasticNN-ResNet50" + "/CIFAR100"
    num_classes = 100
    ...
    imageStr = {
        ...
        "ax0_title": "ElasticNN-ResNet50 test on CIFAR 100",
        "ax1_set_ylabel": "f1 score on CIFAR-10",
        "ax1_title": "f1 score ElasticNN-ResNet50 test on CIFAR 100",
        "save_fig" : "ElasticNN-ResNet50_CIFAR_100.pdf"
    }
   # ==============Done parameters============
    ...
    LOG("Pre-training CIFAR-100 on ElasticNN-ResNet50...", logFile)
