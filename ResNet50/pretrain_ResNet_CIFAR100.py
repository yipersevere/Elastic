...
def pretrain():
    ...
    folder_path = "./Train_ResNet50" + "/CIFAR100"
    num_classes = 100
    ...
    imageStr = {
        ...
        "ax0_title": "ResNet-50 test on CIFAR 100",
        "ax1_set_ylabel": "f1 score on CIFAR-100",
        "ax1_title": "f1 score ResNet-50 test on CIFAR 100",
        "save_fig" : "ResNet-50_CIFAR_100.pdf"
    }
   # ==============Done parameters============
