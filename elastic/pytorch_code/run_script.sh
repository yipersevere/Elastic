...
--layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR100_all_intermediate_classifiers_Elastic_ResNet50_bp1
...
#SqueezeNet
    #CIFAR100
python main.py --model Elastic_SqueezeNet --data cifar100 --num_classes 100 --batch_size 16 --epochs 100 --learning_rate 1e-3 --add_intermediate_layers 2 --layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR100_all_intermediate_Elastic_SqueezeNet_bp3_no_pretrain

python main.py --model Elastic_SqueezeNet --data cifar100 --num_classes 100 --batch_size 16 --epochs 100 --learning_rate 1e-3 --add_intermediate_layers 0 --layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR100_0_intermediate_Elastic_SqueezeNet_bp3_no_pretrain
...
--layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR100_all_intermediate_Elastic_MobileNet_bp1
...
--layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR10_0_intermediate_Elastic_DenseNet121_include_pretrain_skip_last_interCLF
    ...
    #CIFAR100
python main.py --model Elastic_DenseNet121 --data cifar100 --num_classes 100 --batch_size 16 --epochs 100 --add_intermediate_layers 2 \
--layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR100_all_intermediate_Elastic_DenseNet121_diff_BP_two_loop

python main.py --model Elastic_DenseNet121 --data cifar100 --num_classes 100 --batch_size 16 --epochs 100 --add_intermediate_layers 0 \
--layers_weight_change 0 --pretrained_weight 1 --model_name pytorch_CIFAR100_0_intermediate_Elastic_DenseNet121_include_pretrain_skip_last_interCLF
......
......
