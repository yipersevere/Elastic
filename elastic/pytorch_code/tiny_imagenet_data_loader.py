...
def tiny_image_data_loader(data):
    ...
    train_batch_size = 16 # total 500*200 images, 1000 batches of 100 images each
    validation_batch_size = 16  # total 10000 images, 10 batches of 1000 images each
    ...
    return train_data_loader, validation_data_loader, tiny_class


# if __name__ == "__main__":
#     train_data_loader, validation_data_loader, tiny_class = tiny_image_data_loader()
#     print("done")